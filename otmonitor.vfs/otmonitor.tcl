...
register 30	{s16}		"Solar collector temperature"
...
register 38	{f8.8}		"Relative humidity"
register 77	{nu u8}		"Relative ventilation"
register 78	{nu u8}		"Relative humidity exhaust air"
...
register 112	{u16}		"Cumulative electricity production"
...
register 107	{u8 nu}		"Size of fault buffer solar storage"
