...
register 36	{f8.8}		"Electrical current through burner flame"
register 37	{f8.8}		"Room temperature for 2nd CH circuit"
register 38	{u8 u8}		"Relative Humidity"
...
register 98	{f8.8}		"For a specific RF sensor the RF strength and battery level is written" ;# Data-type assumed
register 99	{f8.8}		"Operating Mode HC1, HC2/ Operating Mode DHW"				;# Data-type assumed
...
register 112	{u16}		"Cumulativ Electricity production"
